...
import com.yunmel.syncretic.utils.jse.Reflections;
...
public class CollectionsUtils{
  ...
  public static List extractToList(final Collection collection, final String propertyName) {
    List list = Lists.newArrayList(collection.size());
  ...
  public static <T extends BaseEntity> List<T> maplist2EntityMapList(
      List<Map<String, Object>> mapList, Class<T> beanClass) {
